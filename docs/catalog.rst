...
Catalog
---------
The :samp:`Catalog` class is an extension of the the :ref:`base` class and in inherits all of the :samp:`Base` class' functionality.

Primary Methods
"""""""""""""""

.. autoclass:: coinmetrics.community.Catalog
...
The methods are designed to provide a simple way to get a single metric, and essentially extend the :py:func:`coinmetrics.community.Catalog.get_asset_metric_data` method.

.. autoclass:: coinmetrics.Catalog
    :members: 
